/********************************************************************************
 * CSHARP Diagnostics Standard Library - General utility to write log messages to 
 * different log types. 
 * 
...
namespace CSHARPStandard.Diagnostics.Speaking
{
    using CSHARPStandard.TextToSpeech.VoiceRss;
